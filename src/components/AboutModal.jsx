        ...
        <div className="p-10">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 mb-10 border border-blue-100">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">
                Plateforme de surveillance IoT avancée conçue pour les
                infrastructures critiques. Notre solution combine{' '}
                <strong>analytics en temps réel</strong>,{' '}
                <strong>intelligence artificielle</strong> et
                <strong> alertes prédictives</strong> pour garantir la
                performance optimale de vos datacenters.
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="font-bold text-gray-800 mb-3 text-lg">
                  📊 Analytics Multicouches
                </h3>
                <p className="text-gray-600">
                  Visualisations avancées avec Chart.js, analyses de tendances
                  et métriques en temps réel pour une prise de décision
                  optimale.
                </p>
              </div>
              {/* Bloc 2 */}
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-gray-600">
                  Système d'alertes intelligent avec détection automatique des
                  anomalies et notifications prédictives.
                </p>
              </div>
              {/* Bloc 3 */}
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 border border-purple-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-gray-600">
                  Analyses de tendances et prédictions basées sur l'historique
                  des données pour anticiper les problèmes.
                </p>
              </div>
              {/* Bloc 4 */}
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-6 border border-orange-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-gray-600">
                  Statistiques journalières, hebdomadaires et mensuelles avec
                  comparaisons et export de données.
                </p>
              </div>
              {/* Bloc 5 */}
              <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-6 border border-red-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-gray-600">
                  Authentification API, chiffrement des données et monitoring de
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl p-6 border border-indigo-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-gray-600">
                  Design moderne et responsive compatible avec tous les
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-8 mb-10 border border-gray-200">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="text-3xl font-black bg-gradient-to-r from-green-600 to-green-700 bg-clip-text text-transparent mb-2">
                  15+
                </div>
                <div className="text-sm text-gray-600 font-semibold">
                  Métriques
              ...
              <div className="text-center bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="text-3xl font-black bg-gradient-to-r from-purple-600 to-purple-700 bg-clip-text text-transparent mb-2">
                  Multi
                </div>
                <div className="text-sm text-gray-600 font-semibold">Sites</div>
              </div>
              <div className="text-center bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="text-3xl font-black bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent mb-2">
                  24/7
                </div>
                <div className="text-sm text-gray-600 font-semibold">
                  Monitoring
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-3xl p-8 mb-10 border border-indigo-200">
            <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center flex items-center justify-center">
              <FontAwesomeIcon icon={faCode} className="text-indigo-600 mr-3" />
              Stack Technologique
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
          ...
          <div className="text-center">
            <div className="flex justify-center space-x-4 mb-6 flex-wrap">
              <a
                href="index.html"
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
                <FontAwesomeIcon icon={faHome} className="mr-3" />
                Page d'accueil
              </a>
              <a
                href="https://zmdsgzswdovyxrvkfjml.supabase.co"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
                <FontAwesomeIcon icon={faDatabase} className="mr-2" />
                Base de Données Supabase
              </a>
              <a
                href="https://zmdsgzswdovyxrvkfjml.supabase.co/rest/v1/api_sensorreading"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
